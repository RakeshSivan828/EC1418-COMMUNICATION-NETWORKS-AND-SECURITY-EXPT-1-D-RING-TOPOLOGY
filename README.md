# EC1418-COMMUNICATION-NETWORKS-AND-SECURITY-EXPT-1-D--RING
RING TOPOLOGY -CISCO

# AIM 
 To simulate a network with Ring Topology, using Cisco Packet Tracer and to verify the connectivity between computer using ICMP.
# EQUIPMENTS REQUIRED
